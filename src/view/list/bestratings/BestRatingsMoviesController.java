...
public class BestRatingsMoviesController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        for(Movie movie : ModelMovie.getInstance().readAllMovies()){
            ...
            if(movie.getMinimumAge() <= currentYear - userAge) {
                if (ModelRating.getInstance().readAvgRatingByMovie(movie) > 5.0) {
                    if (posX <= 788) {
