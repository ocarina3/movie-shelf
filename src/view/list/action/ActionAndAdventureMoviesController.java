...
public class ActionAndAdventureMoviesController implements Initializable {
     ...
     * de ação e aventura e mostra na tela
     * */
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        for(Movie movie : ModelMovie.getInstance().readAllMovies()){
            ...
            if(movie.getMinimumAge() <= currentYear - userAge) {
                if ((movie.getMovieGenre().getDescription()).equals("Ação e Aventura")) {
                    if (posX <= 788) {
